...
$config['smtp_host']        = '192.168.10.4';
$config['smtp_user']        = 'tolotra_si';
$config['smtp_pass']        = 'Si2016';
$config['smtp_port']        = 25;
$config['smtp_timeout']     = 15;                 // SMTP connection options, an array passed to the function stream_context_create() when connecting via SMTP.
$config['wordwrap']         = true;
$config['wrapchars']        = 76;
$config['mailtype']         = 'html';                   // 'text' or 'html'
$config['charset']          = 'UTF-8';                     // 'UTF-8', 'ISO-8859-15', ...; $config['smtp_crypto']      = '';                       // '' or 'tls' or 'ssl'
$config['smtp_debug']       = 0;                        // PHPMailer's SMTP debug info level: 0 = off, 1 = commands, 2 = commands and data, 3 = as 2 plus connection status, 4 = low level data output. automatically if a server supports it, even if `smtp_crypto` is not set to 'tls'.
