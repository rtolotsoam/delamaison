...
<head>
	...
	<!-- 
	<link rel="stylesheet/less" href="<?php echo js_url('js/module.admin.page.widgets.less'); ?>" />
	-->

	<!--[if lt IE 9]><link rel="stylesheet" href="<?php echo css_url('admin/bootstrap.min'); ?>" /><![endif]-->
	<?php 
	if(isset($css)){
	...
	<script src="<?php echo js_url('library/jquery-ui/js/jquery-ui.min.js?v=v1.2.3'); ?>"></script>
	<script src="<?php echo js_url('plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js?v=v1.2.3'); ?>"></script>

	<script src="<?php echo js_url('js/dist/jstree.js'); ?>"></script>	
</head>

<body class="sidebar-mini" <?php if($titre == "PROCESSUS" && isset($dern)){ echo "onload=\"click_lien(".$dern.")\""; } ?>>
